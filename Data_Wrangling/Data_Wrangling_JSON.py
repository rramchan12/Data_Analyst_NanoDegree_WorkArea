...
proxies = {
  'http': 'http://cis-india-pitc-bangalorez.proxy.corporate.ge.com:80',
...
def query_site(url, params, uid="", fmt="json"):
    ...
    """
    params["fmt"] = fmt
    r = requests.get(url + uid, params=params, proxies=proxies)
...
def main():
    ...
    #Bands Named First Aid Kit
    artists_named_first_aid_kit = query_by_name(ARTIST_URL, query_type["simple"], "First Aid Kit")
    pretty_print(artists_named_first_aid_kit)
    print("No of artists named FIRST AID KIT is %d" %len(artists_named_first_aid_kit))

    artists_named_queen = query_by_name(ARTIST_URL, query_type["simple"],"QUEEN")
    print(len(artists_named_queen))
    pretty_print(artists_named_queen)
